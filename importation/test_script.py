...
class test_script(object):
    ...
    def test_script(self):
        try:
            ...
            res = self.execute('sale.order.line', 'product_id_change_with_wh', [], 1, 5753, 0, False, 0, False,'', 2167)
            print res
        except Exception, e:
            print "EXCEPTION: REC: ",(self.loc_name)
        return True
...
if __name__ == "__main__":
    if len(sys.argv) < 4:
        ...
        test_script(sys.argv[1], sys.argv[2], sys.argv[3])
